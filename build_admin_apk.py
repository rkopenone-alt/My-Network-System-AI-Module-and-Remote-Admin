...
new_strings = strings_content.replace('Rescuer Field App', 'ARDMS Admin')
with open(strings_xml, 'w', encoding='utf-8') as f:
    f.write(new_strings)

new_gradle = gradle_content.replace("applicationId 'com.rescue.rescuer'", "applicationId 'com.rescue.admin'")
